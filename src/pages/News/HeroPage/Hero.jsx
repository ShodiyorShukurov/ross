...
import bg1 from '../../../assets/MaxRoy/view_004.jpg';
  ...
  return (
    ...
    >
      ...
      <div className="z-10 container">
        ...
        <div className="absolute flex flex-col text-center items-center text-[#fff] left-1/2 transform -translate-x-1/2 bottom-20  w-full lg:w-auto">
          <h1
            className="text-[40px] md:text-[60px] lg:text-[80px] leading-[53px] md:leading-[70px] lg:leading-[96px] font-bold w-[100%]"
