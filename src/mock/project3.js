...
import img5 from '../assets/Asia Medline/IMG_1930.JPG';
import img6 from '../assets/Asia Medline/IMG_1931.JPG';
import img9 from '../assets/Asia Medline/IMG_1936.JPG';
...
const id1 = (t) => ({
  projectData: {
    ...
    hero: {
      ...
      button2: t('projects3.button_text2'),
      desc: [
        {
          id: 1,
          place: t('projects3.place'),
          location: t('projects3.place_location'),
        ...
        {
          id: 2,
          place: t('projects3.school'),
          location: t('projects3.school_location'),
        ...
        {
          id: 3,
          place: t('projects3.business_center'),
          location: t('projects3.business_center_location'),
        ...
        {
          id: 4,
          place: t('projects3.sports_complex'),
          location: t('projects3.sports_complex_location'),
    ...
    image_page: {
      title: t('projects3.title'),
      desc: t('projects3.image_desc'),
      images: [img1, img2, img4, img5, img6, img9],
    },
    fact_page: {
      title: t('projects3.fact_title'),
      desc: t('projects3.fact_desc'),
      fact_cards: [
        {
          id: 1,
          title: t('projects3.fact_card1'),
          image: fact_card1,
        },
        {
          id: 2,
          title: t('projects3.fact_card2'),
          image: fact_card2,
        },
        {
          id: 3,
          title: t('projects3.fact_card3'),
          image: fact_card3,
        },
        {
          id: 4,
          title: t('projects3.fact_card4'),
          image: fact_card4,
        },
        {
          id: 5,
          title: t('projects3.fact_card5'),
          image: fact_card5,
        },
      ],
      area_cards: [
        { id: 1, count: t('projects3.area'), text: t('projects3.area_title') },
        {
          id: 2,
          count: t('projects3.home_count'),
          text: t('projects3.home_count_title'),
        },
        {
          id: 3,
          count: t('projects3.floor'),
          text: t('projects3.floor_title'),
        },
        {
          id: 4,
          count: t('projects3.done_project'),
          text: t('projects3.done_project_title'),
        },
      ],
    },
    calculator_page: {
      title: t('projects3.calculator'),
      subtitle: t('projects3.calculator_title'),
      area_input: t('projects3.area_input'),
      block1: t('projects3.block1'),
      block2: t('projects3.block2'),
      block3: t('projects3.block3'),
      block4: t('projects3.block4'),
      floor1: t('projects3.floor1'),
      floor2: t('projects3.floor2'),
      floor3: t('projects3.floor3'),
      calculator_business: t('projects3.calculator_business'),
      area_sum: t('projects3.area_sum'),
      area_sum_text: t('projects3.area_sum_text'),
      total_amount: t('projects3.total_amount'),
      calculator_button: t('projects3.calculator_button'),
    },
    map_page: {
      ...
      foot_location: [
        ...
        t('projects3.foot_text2'),
        t('projects3.foot_text3'),
        t('projects3.foot_text4'),
      ],
      car: t('projects3.car'),
      car_location: [
        t('projects3.car_text1'),
        t('projects3.car_text2'),
        t('projects3.car_text3'),
        t('projects3.car_text4'),
      ],
    },
  },
});
