...
const id1 = (t) => ({
  projectData: {
    ...
    hero: {
      ...
      button2: t('projects7.button_text2'),
      desc: [
        {
          id: 1,
          place: t('projects7.place'),
          location: t('projects7.place_location'),
        ...
        {
          id: 2,
          place: t('projects7.school'),
          location: t('projects7.school_location'),
        ...
        {
          id: 3,
          place: t('projects7.business_center'),
          location: t('projects7.business_center_location'),
        ...
        {
          id: 4,
          place: t('projects7.sports_complex'),
          location: t('projects7.sports_complex_location'),
    ...
    fact_page: {
      area_cards: [
        ...
        { id: 2, count: t('projects7.home_count'), text: t('projects7.home_count_title') },
        {
          ...
          text: t('projects7.floor_title'),
        },
        {
          id: 4,
          count: t('projects7.done_project'),
          text: t('projects7.done_project_title'),
        },
      ],
    },
    calculator_page: {
      title: t('projects7.calculator'),
      subtitle: t('projects7.calculator_title'),
      area_input: t('projects7.area_input'),
      block1: t('projects7.block1'),
      block2: t('projects7.block2'),
      block3: t('projects7.block3'),
      block4: t('projects7.block4'),
      floor1: t('projects7.floor1'),
      floor2: t('projects7.floor2'),
      floor3: t('projects7.floor3'),
      calculator_business: t('projects7.calculator_business'),
      area_sum: t('projects7.area_sum'),
      area_sum_text: t('projects7.area_sum_text'),
      total_amount: t('projects7.total_amount'),
      calculator_button: t('projects7.calculator_button'),
    },
    map_page: {
      title: t('projects7.location_title'),
      position: { lat: 41.32044, lng: 69.268078 },
      foot: t('projects7.foot'),
      foot_location: [
        t('projects7.foot_text1'),
        t('projects7.foot_text3'),
        t('projects7.foot_text4'),
      ],
      car: t('projects7.car'),
      car_location: [
        t('projects7.car_text1'),
        t('projects7.car_text2'),
        t('projects7.car_text4'),
      ],
    },
  },
});
