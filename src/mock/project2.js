...
import img1 from '../assets/nurafshon/Q3N.jpg';
import img2 from '../assets/nurafshon/Q1.jpg';
import img4 from '../assets/nurafshon/Q2.jpg';
import img5 from '../assets/nurafshon/Q6D.jpg';
...
const id1 = (t) => ({
  projectData: {
    ...
    hero: {
      ...
      button2: t('projects2.button_text2'),
      desc: [
        {
          id: 1,
          place: t('projects2.place'),
          location: t('projects2.place_location'),
        ...
        {
          id: 2,
          place: t('projects2.school'),
          location: t('projects2.school_location'),
        ...
        {
          id: 3,
          place: t('projects2.business_center'),
          location: t('projects2.business_center_location'),
        ...
        {
          id: 4,
          place: t('projects2.sports_complex'),
          location: t('projects2.sports_complex_location'),
    ...
    image_page: {
      title: t('projects2.title'),
      desc: t('projects2.image_desc'),
      images: [img1, img2, img4, img5],
    },
    fact_page: {
      title: t('projects2.fact_title'),
      desc: t('projects2.fact_desc'),
      fact_cards: [
        {
          id: 1,
          title: t('projects2.fact_card1'),
          image: fact_card1,
        },
        {
          id: 2,
          title: t('projects2.fact_card2'),
          image: fact_card2,
        },
        {
          id: 3,
          title: t('projects2.fact_card3'),
          image: fact_card3,
        },
        {
          id: 4,
          title: t('projects2.fact_card4'),
          image: fact_card4,
        },
        {
          id: 5,
          title: t('projects2.fact_card5'),
          image: fact_card5,
        },
      ],
      area_cards: [
        { id: 1, count: t('projects2.area'), text: t('projects2.area_title') },
        {
          id: 2,
          count: t('projects2.home_count'),
          text: t('projects2.home_count_title'),
        },
        {
          id: 3,
          count: t('projects2.floor'),
          text: t('projects2.floor_title'),
        },
        {
          id: 4,
          count: t('projects2.done_project'),
          text: t('projects2.done_project_title'),
        },
      ],
    },
    calculator_page: {
      title: t('projects2.calculator'),
      subtitle: t('projects2.calculator_title'),
      area_input: t('projects2.area_input'),
      block1: t('projects2.block1'),
      floor1: t('projects2.floor1'),
      floor2: t('projects2.floor2'),
      floor3: t('projects2.floor3'),
      floor4: t('projects2.floor4'),
      floor5: t('projects2.floor5'),
      floor6: t('projects2.floor6'),
      floor7: t('projects2.floor7'),
      calculator_business: t('projects2.calculator_business'),
      area_sum1: t('projects2.area_sum1'),
      area_sum2: t('projects2.area_sum2'),
      area_sum_text: t('projects2.area_sum_text'),
      total_amount: t('projects2.total_amount'),
      calculator_button: t('projects2.calculator_button'),
    },
    map_page: {
      title: t('projects2.location_title'),
      position: { lat: 41.341622, lng:  69.233231 },
      foot: t('projects2.foot'),
      foot_location: [
        t('projects2.foot_text1'),
        t('projects2.foot_text2'),
        t('projects2.foot_text3'),
        t('projects2.foot_text4'),
      ],
      car: t('projects2.car'),
      car_location: [
        t('projects2.car_text1'),
        t('projects2.car_text2'),
        t('projects2.car_text3'),
        t('projects2.car_text4'),
      ],
    },
  },
});
