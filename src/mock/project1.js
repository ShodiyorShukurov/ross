  ...
  projectData: {
    ...
    hero: {
      ...
      desc: [
        {
          id: 1,
          place: t('projects1.place'),
          location: t('projects1.place_location'),
        ...
        {
          id: 2,
          place: t('projects1.school'),
          location: t('projects1.school_location'),
        ...
        {
          id: 3,
          place: t('projects1.business_center'),
          location: t('projects1.business_center_location'),
    ...
    fact_page: {
      ...
      area_cards: [
        { id: 1, count: t('projects1.area'), text: t('projects1.area_title') },
        {
          id: 2,
          count: t('projects1.home_count'),
          text: t('projects1.home_count_title'),
        },
        {
          id: 3,
          count: t('projects1.floor'),
    ...
    calculator_page: {
      title: t('projects1.calculator'),
      subtitle: t('projects1.calculator_title'),
      area_input: t('projects1.area_input'),
      block1: t('projects1.block1'),
      block2: t('projects1.block2'),
      block3: t('projects1.block3'),
      block4: t('projects1.block4'),
      floor1: t('projects1.floor1'),
      floor2: t('projects1.floor2'),
      floor3: t('projects1.floor3'),
      calculator_business: t('projects1.calculator_business'),
      area_sum: t('projects1.area_sum'),
      area_sum_text: t('projects1.area_sum_text'),
      total_amount: t('projects1.total_amount'),
      calculator_button: t('projects1.calculator_button'),
    },
    map_page: {
      ...
      foot_location: [
        ...
        t('projects1.foot_text2'),
        t('projects1.foot_text3'),
        t('projects1.foot_text4'),
      ],
      car: t('projects1.car'),
      car_location: [
        t('projects1.car_text1'),
        t('projects1.car_text2'),
        t('projects1.car_text3'),
        t('projects1.car_text4'),
      ],
    },
  },
});
