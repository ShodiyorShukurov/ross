import bg from '../assets/The Knowledge center/IMG_2039.JPG';
...
import img5 from '../assets/The Knowledge center/IMG_2051.JPG';
import img6 from '../assets/The Knowledge center/IMG_2053.JPG';
import img9 from '../assets/The Knowledge center/IMG_2055.JPG';
import img3 from '../assets/The Knowledge center/IMG_2062.JPG';
import img7 from '../assets/The Knowledge center/IMG_2064.JPG';
import img8 from '../assets/The Knowledge center/IMG_2070.JPG';
...
const id1 = (t) => ({
  projectData: {
    ...
    hero: {
      ...
      subtitle: t('projects4.subtitle'),
      button1: t('projects4.button_text1'),
      button2: t('projects4.button_text2'),
      desc: [
        {
          id: 1,
          place: t('projects4.place'),
          location: t('projects4.place_location'),
        ...
        {
          id: 2,
          place: t('projects4.school'),
          location: t('projects4.school_location'),
        ...
        {
          id: 3,
          place: t('projects4.business_center'),
          location: t('projects4.business_center_location'),
        ...
        {
          id: 4,
          place: t('projects4.sports_complex'),
          location: t('projects4.sports_complex_location'),
    ...
    image_page: {
      title: t('projects4.title'),
      desc: t('projects4.image_desc'),
      images: [img1, img2, img4, img5, img6, img9, img3, img7, img8],
    },
    fact_page: {
      title: t('projects4.fact_title'),
      desc: t('projects4.fact_desc'),
      fact_cards: [
        {
          id: 1,
          title: t('projects4.fact_card1'),
          image: fact_card1,
        },
        {
          id: 2,
          title: t('projects4.fact_card2'),
          image: fact_card2,
        },
        {
          id: 3,
          title: t('projects4.fact_card3'),
          image: fact_card3,
        },
        {
          id: 4,
          title: t('projects4.fact_card4'),
          image: fact_card4,
        },
        {
          id: 5,
          title: t('projects4.fact_card5'),
          image: fact_card5,
        },
      ],
      area_cards: [
        { id: 1, count: t('projects4.area'), text: t('projects4.area_title') },
        {
          id: 3,
          count: t('projects4.floor'),
          text: t('projects4.floor_title'),
        },
        {
          id: 4,
          count: t('projects4.done_project'),
          text: t('projects4.done_project_title'),
        },
      ],
    },
    calculator_page: {
      title: t('projects4.calculator'),
      subtitle: t('projects4.calculator_title'),
      area_input: t('projects4.area_input'),
      block1: t('projects4.block1'),
      block2: t('projects4.block2'),
      block3: t('projects4.block3'),
      block4: t('projects4.block4'),
      floor1: t('projects4.floor1'),
      floor2: t('projects4.floor2'),
      floor3: t('projects4.floor3'),
      calculator_business: t('projects4.calculator_business'),
      area_sum: t('projects4.area_sum'),
      area_sum_text: t('projects4.area_sum_text'),
      total_amount: t('projects4.total_amount'),
      calculator_button: t('projects4.calculator_button'),
    },
    map_page: {
      title: t('projects4.location_title'),
      position: { lat: 41.342476, lng: 69.207431 },
      foot: t('projects4.foot'),
      foot_location: [
        t('projects4.foot_text1'),
        t('projects4.foot_text3'),
        t('projects4.foot_text4'),
      ],
      car: t('projects4.car'),
      car_location: [
        t('projects4.car_text1'),
        t('projects4.car_text2'),
        t('projects4.car_text4'),
      ],
    },
  },
});
